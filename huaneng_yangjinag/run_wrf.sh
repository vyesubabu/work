...
export WRF_DIR=/home/xuwq/wrf_3.7.1/WRFV3/run
export RUN_MPI="/share/apps/intel/impi/4.1.1.036/intel64/bin/mpirun -np 16 "
################################################
case_name="huaneng_2012"
date_start="2012022712"
date_end="2012022912"
time_interval="24"         
run_day="1"
run_hour="12"
namelist_dir=/home2_hn/xuwq/github/work/huaneng_yangjinag
...
#    mv real.output       ${real_output_dir}
    rm -f ${real_output_dir}/namelist.input
