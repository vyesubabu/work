class observation(object):
    def __init__(self):
        ...
        default_float       = 0.
        default_int         = 0
        self.station_id_c   = default_str
        self.lat            = default_float 
        self.lon            = default_float 
        self.pres_height    = default_float
        self.station_height = default_float
        self.year           = default_int
        self.mon            = default_int
        self.day            = default_int
        self.hour           = default_int
        self.prs            = default_float
        self.prs_sea        = default_float
        self.prs_max        = default_float
        self.prs_min        = default_float
        self.win_s_max      = default_float
        self.win_s_inst_max = default_float
        self.win_d_inst_max = default_float 
        self.win_d_avg_10mi = default_float
        self.win_s_avg_10mi = default_float
        self.win_d_s_max    = default_float
        self.tem            = default_float
        self.tem_max        = default_float
        self.tem_min        = default_float
        self.rhu            = default_float
        self.vap            = default_float
        self.rhu_min        = default_float
        self.pre_1h         = default_float
