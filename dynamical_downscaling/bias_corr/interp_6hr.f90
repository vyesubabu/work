...
! Updated Feb 2015 - Cindy Bruyere
  ...
  INTEGER, DIMENSION(12), PARAMETER :: WEIGHTS = (/ 124, 112, 124, 120, 124, 120, 124, 124, 120, 124, 120, 124 /)
  INTEGER, PARAMETER :: NFILES = 1460
  INTEGER, PARAMETER :: interval_hours = 6
  CHARACTER(len=250), DIMENSION(12) :: FILES
