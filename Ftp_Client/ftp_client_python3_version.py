...
if __name__ == '__main__':
    # read configure file
    configures = {}
    with open('./configure.ftp', 'r') as configure:
        for i in [ line.split('=') for line in configure.readlines() if '=' in line ]:
            configures[i[0].strip()] = i[1].strip()
    ...
    # ftp
    host = configures['host']
    user = configures['user']
    passwd = configures['passwd']
    remotedir = configures['remotedir']
